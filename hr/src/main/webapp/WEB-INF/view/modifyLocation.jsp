...
<body>
   ...
   <!-- end menu.jsp include -->
      <hr>
		<form method="post"
		action="${pageContext.request.contextPath}/modifyLocation">
		<h1>Location 수정</h1>
		<label for="regionId">regionId : </label> 
		<select id="regionId">
			<option value="${locationMap.REGIONID}">${locationMap.REGIONNAME}</option>
		...
		<option value="${locationMap.COUNTRYID}">${locationMap.COUNTRYNAME}</option>
		</select>  
		<br>
		<label for="locationId">locationId : </label> 
			<input type="text" name="locationId" value="${locationMap.LOCATIONID}" readonly="readonly">
		<br>	
		<label for="streetAddress">streetAddress : </label> 	
			<input type="text" name="streetAddress" value="${locationMap.STREETADDRESS}">
		<br>	
		<label for="postalCode">postalCode : </label> 	
			<input type="text" name="postalCode" value="${locationMap.POSTALCODE}">
		<br>
		<label for="city">city : </label> 		
			<input type="text" name="city" value="${locationMap.CITY}">
		<br>
		<label for="stateProvince">stateProvince : </label> 		
			<input type="text" name="stateProvince"  value="${locationMap.STATEPROVINCE}">
		<br>
		<div>
